...
def create_record(
    ...
    **extra,
    ...
    return empty_record(
        ...
        candidate_groups=extra.get("candidate_groups", ()),
        candidate_ranking=extra.get("candidate_ranking", ()),
        selected_candidate_id=extra.get("selected_candidate_id", ""),
        selected_vehicle_ids=extra.get("selected_vehicle_ids", ()),
        candidate_selection_reason=extra.get("candidate_selection_reason", ""),
        llm_raw_output=extra.get("llm_raw_output", ""),
        llm_candidate_id=extra.get("llm_candidate_id", ""),
        deterministic_candidate_id=extra.get("deterministic_candidate_id", ""),
        candidate_agreement=extra.get("candidate_agreement", None),
        candidate_disagreement=extra.get("candidate_disagreement", False),
        fallback_selected_candidate=extra.get("fallback_selected_candidate", ""),
        final_selected_candidate=extra.get("final_selected_candidate", ""),
        selection_source=extra.get("selection_source", ""),
        safety_intervened=extra.get("safety_intervened", False),
